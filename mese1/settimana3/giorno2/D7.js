...
*/
const concStringhe = (stringa1, stringa2) => {
  const inizioStringa1 = stringa1.slice(0, 2);
  const fineStringa2 = stringa2.slice(-3);
  let risultato = inizioStringa1 + fineStringa2;
  risultato = risultato.toUpperCase();
  console.log(risultato);
};
concStringhe("odio", "Javascript");
